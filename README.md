...
- **Weekly timetable** a Mon–Fri, 9 am–7 pm grid in 15-minute increments. Click any square, pick a duration (from 15 minutes up to 4 hours), and assign a topic so a class running 4:00–5:15 fits exactly, not rounded up to a full hour.
...
- **Apple Calendar bridge (.ics)** since a website can't get live, two-way access to the Calendar app, this uses the standard interchange format instead:
  ...
  - Neither direction is "live": reexport or reimport whenever something changes.
